...
public class Client {
	...
	private final File DATA_FILE = new File(mc.mcDataDir, "bruh_client_mods.json");
	...
	public static final String NAME = "Bruh Client " + VERSION;
	public static final String KEY_TRANSLATION_KEY = "bruh_client.key";
	...
	public void init() {
		...
		System.setProperty("http.agent", "Bruh Client/" + Client.VERSION);
